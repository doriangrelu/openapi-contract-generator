 ...
 *
 * <ul>
 *   <li>{@link io.github.doriangrelu.contract.ApiContract @ApiContract} — on an interface,
 *       "this is a set of HTTP endpoints".</li>
 *   <li>{@link io.github.doriangrelu.contract.ApiDomain @ApiDomain} — on a
 ...
 * {@code io.github.doriangrelu:openapi-contract-generator} (test scope).
 */
